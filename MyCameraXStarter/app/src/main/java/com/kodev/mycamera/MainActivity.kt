...
import com.kodev.mycamera.databinding.ActivityMainBinding
        ...
        if (getFile != null) {
            ...
            service.enqueue(object : Callback<FileUploadResponse> {
                ...
                override fun onFailure(call: Call<FileUploadResponse>, t: Throwable) {
                    Toast.makeText(this@MainActivity, "Gagal Menghubngkan ke Retrofit", Toast.LENGTH_SHORT).show()
                }

            })

        } else {
            Toast.makeText(this, "Silakan Masukan Gambar Terlebih Dahulu", Toast.LENGTH_SHORT).show()
        }
    }
